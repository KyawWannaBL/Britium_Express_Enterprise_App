...
export function DashboardModule() {
  ...
  return (
    <div className="space-y-4">
      <SectionTitle
        title={getBiText({ en: "Dashboard", my: "ဒက်ရှ်ဘုတ်" }, languageMode)}
        subtitle={getBiText({ en: "KPI, approvals, fraud, and recent activity", my: "KPI၊ approval၊ fraud နှင့် မကြာသေးမီလုပ်ဆောင်ချက်များ" }, languageMode)}
      />
      <SurfaceCard>
