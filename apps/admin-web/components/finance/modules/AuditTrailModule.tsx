...
export function AuditTrailModule() {
  ...
  return (
    <div className="space-y-4">
      <SectionTitle
        title={getBiText({ en: "Audit Trail", my: "စစ်ဆေးမှုမှတ်တမ်း" }, languageMode)}
        subtitle={getBiText({ en: "Immutable action history", my: "ပြောင်းလဲ၍မရသော action history" }, languageMode)}
      />
      <SurfaceCard>
