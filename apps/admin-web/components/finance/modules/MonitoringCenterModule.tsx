...
export function MonitoringCenterModule() {
  const { languageMode } = useFinancePortal();

  return (
    <div className="space-y-4">
      <SectionTitle
        title={getBiText({ en: "Real-Time Monitoring", my: "တိုက်ရိုက်စောင့်ကြည့်မှု" }, languageMode)}
        subtitle={getBiText({ en: "Live event feed and branch monitoring widgets", my: "live event feed နှင့် branch monitoring widget များ" }, languageMode)}
      />
      <SurfaceCard>
